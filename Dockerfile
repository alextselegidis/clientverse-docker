...
ENV MAIL_FROM_NAME="Clientverse"
...
RUN a2enmod rewrite \
    ...
    && wget https://github.com/alextselegidis/clientverse/releases/download/${VERSION}/clientverse-${VERSION}.zip \
    && unzip clientverse-${VERSION}.zip \
    && rm clientverse-${VERSION}.zip \
